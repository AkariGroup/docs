...
<head>
  ...
  <title>A guide to masked arrays in NumPy &mdash; AKARI webマニュアル</title>
      <link rel="stylesheet" type="text/css" href="../../../../../../_static/pygments.css?v=b86133f3" />
      <link rel="stylesheet" type="text/css" href="../../../../../../_static/css/akaridoc_theme.css?v=e34f6a5d" />

  
    <link rel="canonical" href="https://akarigroup.github.io/docs/.venv/lib64/python3.12/site-packages/numpy/ma/README.html" />
...
<ul>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/intro.html">はじめに</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/overview/main.html">AKARIの特徴</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/assembly/main.html">AKARIを作ってみよう</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/assembly_light/main.html">AKARI Lightを作ってみよう</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/startup/main.html">AKARIを起動しよう</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/tutorial_web/main.html">AKARIをはじめよう(webコンソール編)</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/tutorial/main.html">AKARIをはじめよう(Ubuntu編)</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/spec/main.html">AKARIの仕様</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/practice/main.html">AKARI練習問題に挑戦しよう</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/scratch/main.html">Scratchを使ってみよう</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/ros2/main.html">ROS2版を使ってみよう</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/dev/main.html">AKARIを使った開発</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/troubleshoot/main.html">困ったときは</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/update/main.html">ソフトのアップデート</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../source/sdk_reference/main.html">SDK リファレンス</a></li>
</ul>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            <a href="../../../../../../_sources/.venv/lib64/python3.12/site-packages/numpy/ma/README.rst.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr/>
</div>
  ...
  <section id="a%20guide%20to%20masked%20arrays%20in%20numpy">
<h1><a class="toc-backref" href="#id1" role="doc-backlink">A guide to masked arrays in NumPy</a><a class="headerlink" href="#a%20guide%20to%20masked%20arrays%20in%20numpy" title="Link to this heading"></a></h1>
<nav class="contents" id="%E7%9B%AE%E6%AC%A1">
<p class="topic-title">目次</p>
<ul class="simple">
<li><p><a class="reference internal" href="#a%20guide%20to%20masked%20arrays%20in%20numpy" id="id1">A guide to masked arrays in NumPy</a></p>
<ul>
<li><p><a class="reference internal" href="#history" id="id2">History</a></p></li>
<li><p><a class="reference internal" href="#main%20differences" id="id3">Main differences</a></p></li>
<li><p><a class="reference internal" href="#new%20features" id="id4">New features</a></p></li>
<li><p><a class="reference internal" href="#using%20the%20new%20package%20with%20numpy.core.ma" id="id5">Using the new package with numpy.core.ma</a></p></li>
<li><p><a class="reference internal" href="#using%20maskedarray%20with%20matplotlib" id="id6">Using maskedarray with matplotlib</a></p></li>
<li><p><a class="reference internal" href="#masked%20records" id="id7">Masked records</a></p></li>
<li><p><a class="reference internal" href="#optimizing%20maskedarray" id="id8">Optimizing maskedarray</a></p></li>
<li><p><a class="reference internal" href="#should%20masked%20arrays%20be%20filled%20before%20processing%20or%20not%3F" id="id9">Should masked arrays be filled before processing or not?</a></p></li>
<li><p><a class="reference internal" href="#thanks" id="id10">Thanks</a></p></li>
<li><p><a class="reference internal" href="#revision%20notes" id="id11">Revision notes</a></p></li>
</ul>
</li>
</ul>
</nav>
...
<section id="main%20differences">
<h2><a class="toc-backref" href="#id3" role="doc-backlink">Main differences</a><a class="headerlink" href="#main%20differences" title="Link to this heading"></a></h2>
<blockquote>
<div><ul class="simple">
...
<section id="new%20features">
<h2><a class="toc-backref" href="#id4" role="doc-backlink">New features</a><a class="headerlink" href="#new%20features" title="Link to this heading"></a></h2>
...
<section id="using%20the%20new%20package%20with%20numpy.core.ma">
<h2><a class="toc-backref" href="#id5" role="doc-backlink">Using the new package with numpy.core.ma</a><a class="headerlink" href="#using%20the%20new%20package%20with%20numpy.core.ma" title="Link to this heading"></a></h2>
...
<section id="using%20maskedarray%20with%20matplotlib">
<h2><a class="toc-backref" href="#id6" role="doc-backlink">Using maskedarray with matplotlib</a><a class="headerlink" href="#using%20maskedarray%20with%20matplotlib" title="Link to this heading"></a></h2>
...
<section id="masked%20records">
<h2><a class="toc-backref" href="#id7" role="doc-backlink">Masked records</a><a class="headerlink" href="#masked%20records" title="Link to this heading"></a></h2>
...
<section id="optimizing%20maskedarray">
<h2><a class="toc-backref" href="#id8" role="doc-backlink">Optimizing maskedarray</a><a class="headerlink" href="#optimizing%20maskedarray" title="Link to this heading"></a></h2>
</section>
<section id="should%20masked%20arrays%20be%20filled%20before%20processing%20or%20not%3F">
<h2><a class="toc-backref" href="#id9" role="doc-backlink">Should masked arrays be filled before processing or not?</a><a class="headerlink" href="#should%20masked%20arrays%20be%20filled%20before%20processing%20or%20not%3F" title="Link to this heading"></a></h2>
...
<section id="revision%20notes">
<h2><a class="toc-backref" href="#id11" role="doc-backlink">Revision notes</a><a class="headerlink" href="#revision%20notes" title="Link to this heading"></a></h2>
<blockquote>
<div><ul class="simple">
