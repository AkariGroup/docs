...
.. code-block:: bash
   ...
   uv run tiny_yolo.py -n yolov6n_coco_416x416 -c configs/yolov6n_coco_416x416.json

YOLOv7tiny

.. code-block:: bash

   uv run tiny_yolo.py -n yolov7tiny_coco_416x416 -c configs/yolov7tiny_coco_416x416.json
